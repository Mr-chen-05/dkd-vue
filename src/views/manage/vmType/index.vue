  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="vmTypeRef" :model="form" :rules="rules" label-width="100px">
        ...
        <!-- 货道数布局 -->
        <el-form-item label="货道数:" prop="vmRow" required>
          <div style="display: flex; align-items: flex-start; gap: 20px">
            <el-form-item prop="vmRow" style="margin-bottom: 0">
            ...
            <el-form-item prop="vmCol" style="margin-bottom: 0">
              <div style="display: flex; align-items: center; gap: 10px">
                <el-input-number
                  v-model="form.vmCol"
                  :min="1"
        ...
        updateVmType(form.value)
          ...
          .catch((error) => {
            ...
            showErrorNotification({
              message,
              footer:
                "若提示无法缩减行列数，请先在设备或货道管理中解除关联后再尝试修改。",
            });
          });
      } else {
        addVmType(form.value)
          .then((response) => {
...
function handleDelete(row) {
  ...
  proxy.$modal
    .confirm('是否确认删除设备类型为"' + _names + '"的数据项？')
    .then(function () {
